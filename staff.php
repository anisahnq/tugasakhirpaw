      ...
      <div class="login_wrapper">
          <section class="login_content">
             <form  action="" autocomplete="on" method="post">
              <h1 style="color:#FFFFFF;">REGISTER STAFF</h1>
              <div>
              ...
              <div>
                <input class="form-control" id="norek" name="norek" required="required" type="text" placeholder="No. Rekening"/>
              </div>
              <div>
                <input class="form-control" id="namabank" name="namabank" required="required" type="text" placeholder="Nama Bank"/>
              </div>
              <div>
